...
class ClinicModel {
  ...
  factory ClinicModel.fromJson(Map<String, dynamic> json) {
    return ClinicModel(
      ...
      healthCareServices:json['healthCareServices']!=null? (json['healthCareServices'] as List).map((item) => HealthCareServiceModel.fromJson(item as Map<String, dynamic>)).toList():[],
    );
  }
