              ...
              child: Column(
                ...
                children: [
                  ...
                  if (encounter.actualEndDate != null)
                    _buildDetailRow(
                      'End',
                      DateFormat('MMM d, y - h:mm a').format(DateTime.parse(encounter.actualEndDate!)),
                    ),
                  if (encounter.specialArrangement?.isNotEmpty ?? false)
                    _buildDetailRow('Special Notes', encounter.specialArrangement),
                ],
              ),
            ),
          ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (encounter.appointment?.startDate != null)
                      _buildDetailRow(
                        'Scheduled',
                        DateFormat('MMM d, y - h:mm a').format(DateTime.parse(encounter.appointment!.startDate!)),
                      ),
