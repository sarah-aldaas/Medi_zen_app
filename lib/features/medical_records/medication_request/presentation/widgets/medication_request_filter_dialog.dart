...
class MedicationRequestFilterDialog extends StatefulWidget {
  ...
  const MedicationRequestFilterDialog({required this.currentFilter, super.key});
...
class _MedicationRequestFilterDialogState
  ...
  void initState() {
    ...
    context.read<ConditionsCubit>().getAllConditions(context: context);
  }
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: "filterMedicationRequests.searchHint".tr(
                          context,
                        ),
                    ...
                    CheckboxListTile(
                      title: Text(
                        "filterMedicationRequests.doNotPerformLabel".tr(
                          context,
                        ),
                      ),
                        ...
                        return Column(
                          children: [
                            RadioListTile<String?>(
                              title: Text(
                                "filterMedicationRequests.allStatuses".tr(
                                  context,
                                ),
                              ),
                              value: null,
                    ...
                    BlocBuilder<CodeTypesCubit, CodeTypesState>(
                      builder: (context, state) {
                        ...
                        return DropdownButtonFormField<String>(
                          ...
                          hint: Text(
                            "filterMedicationRequests.selectIntent".tr(context),
                          ),
                          ...
                          items: [
                            DropdownMenuItem<String>(
                              value: null,
                              child: Text(
                                "filterMedicationRequests.allIntents".tr(
                                  context,
                                ),
                              ),
                            ),
                    ...
                    BlocBuilder<CodeTypesCubit, CodeTypesState>(
                      builder: (context, state) {
                        ...
                        return DropdownButtonFormField<String>(
                          ...
                          hint: Text(
                            "filterMedicationRequests.selectPriority".tr(
                              context,
                            ),
                          ),
                          ...
                          items: [
                            DropdownMenuItem<String>(
                              value: null,
                              child: Text(
                                "filterMedicationRequests.allPriorities".tr(
                                  context,
                                ),
                              ),
                            ),
                    ...
                    BlocBuilder<CodeTypesCubit, CodeTypesState>(
                      builder: (context, state) {
                        ...
                        return DropdownButtonFormField<String>(
                          ...
                          hint: Text(
                            "filterMedicationRequests.selectCourseOfTherapy".tr(
                              context,
                            ),
                          ),
                          ...
                          items: [
                            DropdownMenuItem<String>(
                              value: null,
                              child: Text(
                                "filterMedicationRequests.allCourses".tr(
                                  context,
                                ),
                              ),
                            ),
                    ...
                    BlocBuilder<ConditionsCubit, ConditionsState>(
                      builder: (context, state) {
                        ...
                        return DropdownButtonFormField<String>(
                          ...
                          hint: Text(
                            "filterMedicationRequests.selectCondition".tr(
                              context,
                            ),
                          ),
                          ...
                          items: [
                            DropdownMenuItem<String>(
                              value: null,
                              child: Text(
                                "filterMedicationRequests.allConditions".tr(
                                  context,
                                ),
                              ),
                            ),
                              ...
                              (condition) => DropdownMenuItem<String>(
                                ...
                                child: Text(
                                  condition.healthIssue ??
                                      "filterMedicationRequests.unknownCondition"
                                          .tr(context),
                                ),
                              ),
                            ),
                    ...
                    ListTile(
                      ...
                      title: Text(
                        _selectedStartDate != null
                            ...
                            : "filterMedicationRequests.selectStartDate".tr(
                              context,
                            ),
                        style: TextStyle(
                          color:
                    ...
                    ListTile(
                      ...
                      title: Text(
                        _selectedEndDate != null
                            ...
                            : "filterMedicationRequests.selectEndDate".tr(
                              context,
                            ),
                        style: TextStyle(
                          color:
                    ...
                    Row(
                      ...
                      children: [
                        TextButton(
                          ...
                          child: Text(
                            "filterMedicationRequests.clearFilters".tr(context),
                        ...
                        Row(
                          children: [
                            TextButton(
                              onPressed: () => Navigator.pop(context),
                              child: Text(
                                "filterMedicationRequests.cancel".tr(context),
                              ),
                            ),
                            ElevatedButton(
                              onPressed: () {
                              ...
                              child: Text(
                                "filterMedicationRequests.apply".tr(context),
                              ),
                            ),
                          ],
                        ),
