...
class _MedicationRequestDetailsPageState
          ...
          _buildInfoSection(
            ...
            children: [
              ...
              _buildDetailRow(
                ...
                value: request.statusChanged != null
                    ? DateFormat(
                  'MMM d, yyyy - hh:mm a',
            ...
            _buildInfoSection(
              ...
              children: [
                ...
                _buildDetailRow(
                  ...
                  value: medication.asNeeded != null
                      ? (medication.asNeeded!
                ...
                _buildDetailRow(
                  ...
                  value: medication.effectiveMedicationStartDate != null
                      ? DateFormat(
                    'MMM d, yyyy',
                ...
                _buildDetailRow(
                  ...
                  value: medication.effectiveMedicationEndDate != null
                      ? DateFormat(
                    'MMM d, yyyy',
          ...
          if (request.condition != null) ...[
            _buildInfoSection(
              ...
              children: [
                ...
                _buildDetailRow(
                  ...
                  value: request.condition?.isChronic == 1
                      ? 'medicationRequestDetails.yes'.tr(context)
                      : 'medicationRequestDetails.no'.tr(context),
                  icon: Icons.history,
                ),
            ...
            if (request.condition!.encounters != null &&
              ...
              _buildInfoSection(
                ...
                children: request.condition!.encounters!.map((encounter) {
                  return Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          '${"medicationRequestDetails.encounterID".tr(context)}: ${encounter.id}',
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                            color: AppColors.primaryColor,
                          ),
                        ...
                        _buildDetailRow(
                          label: "medicationRequestDetails.actualStartDate"
                              .tr(context),
                          value: encounter.actualStartDate != null
                              ? DateFormat(
                            'MMM d, yyyy - hh:mm a',
                          ).format(
                            DateTime.parse(
                        ...
                        _buildDetailRow(
                          label: "medicationRequestDetails.actualEndDate"
                              .tr(context),
                          value: encounter.actualEndDate != null
                              ? DateFormat(
                            'MMM d, yyyy - hh:mm a',
                          ).format(
                            DateTime.parse(
          ...
          _buildInfoSection(
            ...
            children: [
              ...
              _buildDetailRow(
                ...
                value: request.doNotPerform != null
            ...
            children: [
              Text(
                request.medication?.name ??
                    request.reason ??
                    "medicationRequestDetails.defaultMedicationRequest".tr(context),
  ...
  Widget _buildInfoSection({
    ...
    children.where((widget) => !(widget is SizedBox && widget.key == null)).toList();
