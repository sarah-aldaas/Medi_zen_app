...
class _MedicationRequestDetailsPageState extends State<MedicationRequestDetailsPage> with SingleTickerProviderStateMixin {
  ...
  Widget _buildMedicationTab(MedicationModel? medication) {
    if (medication == null) {
      return Center(
        child: Padding(
          padding: const EdgeInsets.all(24.0),
          child: Text(
            "medicationRequestDetails.noMedicationInfo".tr(context),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoSection(
            ...
            children: [
              _buildDetailRow(label: "medicationRequestDetails.medicationName".tr(context), value: medication.name, icon: Icons.medication_outlined),
              _buildDetailRow(
                label: "medicationRequestDetails.medicationDefinition".tr(context),
              ...
              _buildDetailRow(
                label: "medicationRequestDetails.dosageInstructions".tr(context),
                value: medication.dosageInstructions,
                icon: Icons.text_snippet_outlined,
              ),
              _buildDetailRow(
                label: "medicationRequestDetails.patientInstructions".tr(context),
                value: medication.patientInstructions,
                icon: Icons.person_outline,
              ),
              _buildDetailRow(
                label: "medicationRequestDetails.additionalInstructions".tr(context),
              ...
              _buildDetailRow(
                ...
                value:
                    medication.asNeeded != null
                        ? (medication.asNeeded! ? 'medicationRequestDetails.yes'.tr(context) : 'medicationRequestDetails.no'.tr(context))
                        : null,
                icon: Icons.event_note,
              ),
              _buildDetailRow(
                label: "medicationRequestDetails.medicationStatus".tr(context),
                value: medication.status?.display,
                icon: Icons.check_circle_outline,
              ),
              _buildDetailRow(
                label: "medicationRequestDetails.startDate".tr(context),
                value: medication.effectiveMedicationStartDate != null ? DateFormat('MMM d, yyyy').format(medication.effectiveMedicationStartDate!) : null,
                icon: Icons.event,
              ),
              _buildDetailRow(
                label: "medicationRequestDetails.endDate".tr(context),
                value: medication.effectiveMedicationEndDate != null ? DateFormat('MMM d, yyyy').format(medication.effectiveMedicationEndDate!) : null,
