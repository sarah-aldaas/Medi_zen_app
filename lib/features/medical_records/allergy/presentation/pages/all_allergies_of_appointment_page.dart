...
class AllAllergiesOfAppointmentPage extends StatefulWidget {
  ...
  const AllAllergiesOfAppointmentPage({super.key, required this.appointmentId,required this.filter});

  @override
  State<AllAllergiesOfAppointmentPage> createState() =>
      _AllAllergiesOfAppointmentPageState();
}
