              ...
              child: Column(
                ...
                children: [
                  ...
                  if (allergy.note?.isNotEmpty ?? false)
                    _buildDetailRow('Notes', allergy.note),
                ],
              ),
            ),
          ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (reaction.onSet != null)
                          _buildDetailRow('Onset', DateFormat('MMM d, y - h:mm a').format(DateTime.parse(reaction.onSet!))),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildDetailRow('Special Notes', allergy.encounter?.specialArrangement),
                  ],
                ),
              ),
            ),
