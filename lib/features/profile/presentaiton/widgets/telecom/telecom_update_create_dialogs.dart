...
//                           labelText: 'telecomPage.valueLabel'.tr(
//                             context,
//                           ), // Corrected to valueLabel
//                         ),
//                       ),
//                       const Gap(20),
...
//                         decoration: InputDecoration(
//                           labelText: 'telecomPage.useLabel'.tr(
//                             context,
//                           ), // Corrected to useLabel
//                         ),
//                         value: selectedUse,
//                       ),
//                       const Gap(30),
      ...
      return AlertDialog(
        ...
        content: FutureBuilder<List<List<CodeModel>>>(
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.hasError) {
              return SizedBox(height: 180, child: Center(child: Text('telecomPage.errorLoadingData'.tr(context))));
            }
            ...
            selectedType = telecomTypes.firstWhere(
              (type) => type.id == (telecom.type?.id ?? ''),
              orElse: () => telecomTypes.isNotEmpty ? telecomTypes.first : null as CodeModel,
            );
            selectedUse = telecomUses.firstWhere(
              (use) => use.id == (telecom.use?.id ?? ''),
              orElse: () => telecomUses.isNotEmpty ? telecomUses.first : null as CodeModel,
            );
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          IconButton(onPressed: () => Navigator.pop(context), icon: Icon(Icons.cancel, color: AppColors.secondaryColor)),
                        ],
                      ),
                      const Gap(20),
                      TextField(
                          ...
                          ElevatedButton(
                            onPressed: () {
                              if (valueController.text.isNotEmpty && selectedType != null && selectedUse != null) {
                                ...
                                telecomCubit.updateTelecom(context: context, id: telecom.id!, telecomModel: updatedTelecom);
                                Navigator.pop(context);
                              } else {
                            ...
                            child: Text('telecomPage.update'.tr(context), style: TextStyle(fontSize: 18, color: AppColors.whiteColor)),
                          ),
                        ],
                      ),
                    ],
