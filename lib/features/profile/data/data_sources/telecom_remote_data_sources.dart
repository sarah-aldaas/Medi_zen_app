...
abstract class TelecomRemoteDataSource {
  Future<Resource<PaginatedResponse<TelecomModel>>> getListAllTelecom({required String rank, required String paginationCount});
...
class TelecomRemoteDataSourceImpl implements TelecomRemoteDataSource {
  ...
  Future<Resource<PaginatedResponse<TelecomModel>>> getListAllTelecom({
    ...
    final response = await networkClient.invoke(
      TelecomEndPoints.listAllTelecom(rank: rank, paginationCount: paginationCount),
      RequestType.get,
    );
