...
class _AppointmentFilterDialogState extends State<AppointmentFilterDialog> {
  ...
  void initState() {
    ...
    // Fetch both appointment types and status codes
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    // Status Section - Updated to use code types
                    Text(
                    ...
                    BlocBuilder<CodeTypesCubit, CodeTypesState>(
                      builder: (context, state) {
                        ...
                        if (statusTypes.isEmpty) {
                          return Text(
                            "filterAppointments.noStatusTypes".tr(context),
                            style: const TextStyle(color: Colors.grey),
                          );
                        }
                        return Column(
                    ...
                    // Date and Sort sections remain the same
                    Text(
                        ...
                        Navigator.pop(
                          ...
                          AppointmentFilter(
                            typeId: _selectedTypeId != null
                                ...
                                : null,
                            statusId: _selectedStatusId != null
                                ? int.tryParse(_selectedStatusId!)
                                : null,
...
//     _selectedSort = _filter.sort;
//     context.read<CodeTypesCubit>().getAppointmentTypeCodes(context: context);
//     context.read<CodeTypesCubit>().g(context: context);
//   }
//
//   @override
//   Widget build(BuildContext context) {
