            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon:
                      const Icon(Icons.person, color: Color(0xFF47BD93)),
                  border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(25.0)),
                ),
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return "sign_up_page.validation.first_name_required"
                        .tr(context);
                  }
                  return null;
                },
              ...
              TextFormField(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return "sign_up_page.validation.last_name_required"
                        .tr(context);
                  }
                  return null;
                },
              ...
              TextFormField(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return "sign_up_page.validation.password_required"
                        .tr(context);
                  }
                  if (value.length < 6) {
                    return "sign_up_page.validation.password_length"
                        .tr(context);
                  }
                  return null;
                },
              ...
              ElevatedButton(
                ...
                child: state is SignupLoading
                    ...
                    : Text("sign_up_page.sign_up".tr(context),
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text("sign_up_page.login".tr(context),
                        style:
