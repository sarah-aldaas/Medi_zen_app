        ...
        body: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                CircleAvatar(radius: 70, backgroundImage: AssetImage('images/new password.png')),
                SizedBox(height: 20),
                Text("changePassword.instruction".tr(context), textAlign: TextAlign.center, style: AppStyles.bodyText.copyWith(fontWeight: FontWeight.bold)),
                SizedBox(height: 50),
                TextField(
                    ...
                    return ElevatedButton(
                      onPressed:
                          state is ChangePasswordLoading
                              ? null
                              : () {
                                context.read<ChangePasswordCubit>().changePassword(_newPasswordController.text, _confirmPasswordController.text, context);
                              },
                      ...
                      child:
                          state is ChangePasswordLoading
                              ...
                              : Text("changePassword.button".tr(context), style: AppStyles.bodyText.copyWith(color: AppColors.whiteColor)),
                    );
                  },
                ),
                SizedBox(height: 20),
