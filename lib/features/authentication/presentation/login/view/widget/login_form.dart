          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  Text('login_page.do_not_have_account'.tr(context), style: const TextStyle(color: Colors.grey)),
                  TextButton(
                    onPressed: () {
                      context.pushNamed(AppRouter.signUp.name);
                    },
                    child: Text('login_page.sign_up'.tr(context), style: TextStyle(color: Theme.of(context).primaryColor, fontWeight: FontWeight.bold)),
                  ),
                ],
              ),
              const SizedBox(height: 30),
